...
// ProjectRouting
const FindProjects = Loadable(lazy(() => import('views/projects/findProjects/index')));
const MyProjects = Loadable(lazy(() => import('views/projects/myProjects/index')));
const ProjectDetails = Loadable(lazy(() => import('views/projects/findProjects/ProductDetails/index')));
const ProjectEdit = Loadable(lazy(() => import('views/projects/myProjects/ProjectDetails/index')));
